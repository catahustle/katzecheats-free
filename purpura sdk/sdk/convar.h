...
public:
	...
	void set_value(float value) {
		typedef void(__thiscall* original_fn)(void*, float);
		return global_utils::legacy_v_function<original_fn>(this, 15)(this, value);
	}

	void set_value(int value) {
		typedef void(__thiscall* original_fn)(void*, int);
		return global_utils::legacy_v_function<original_fn>(this, 16)(this, value);
	}
};
