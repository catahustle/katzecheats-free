...
struct c_trace
{
	...
	{
		return entity && entity->ent_index() == 0;
	}
...
public:
	...
	//c_trace_filter_skip_two_entities(const void* passentity = NULL, const void* passentity2 = NULL, int collisionGroup = COLLISION_GROUP_NONE);
