...
public:
	...
	i_material* create_material(const char* mat_name, key_values* key_value)
	{
		using original_fn = i_material*(__thiscall*)(const char*, key_values*);
		return (*(original_fn**)this)[83](mat_name, key_value);
	}
};