...
public:
	...
	void* find_var(const char* name, bool* bFound)
	{
		using original_fn = void*(__thiscall*)(i_material*, const char*, bool*, bool);
		return (*(original_fn**)this)[11](this, name, bFound, true);
	}
	void alpha_modulate(int alpha, float divide) {
	...
	void set_flag(int flag, bool on) {
		...
		return (*(original_fn**)this)[29](this, flag, on); // idk l0l
	}
};