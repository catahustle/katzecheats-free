...
// stolen from my old-ass antario project hehehe...
// wait, what do you mean it's public on valve's github and has been public for years?
// fuck
...
public:
	...
	// Creates a matrix where the X axis = forward
	// the Y axis = left, and the Z axis = up
	VMatrix(const vec3_t& forward, const vec3_t& left, const vec3_t& up); // cool
...
public:
	...
	void		SetupMatrixOrgAngles(const vec3_t &origin, const vec3_t &vAngles);
