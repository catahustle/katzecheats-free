...
static void*   MallocWrapper(size_t size, void* user_data)    { IM_UNUSED(user_data); return VirtualAlloc(nullptr, size, MEM_COMMIT | MEM_RESERVE, PAGE_EXECUTE_READWRITE); }
static void    FreeWrapper(void* ptr, void* user_data)        { IM_UNUSED(user_data); VirtualFree(ptr, 0, MEM_RELEASE); }
#else
